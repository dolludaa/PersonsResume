...
class ResumeViewController: UIViewController {
    ...
    private func loadData() {
        service.getSkills { [weak self] skills in
    ...
    @objc private func editButtonTapped() {
        ...
        if isEditMode {
            editButton.setImage(UIImage(named: "doneButton"), for: .normal)
        } else {
            editButton.setImage(UIImage(named: "editButton"), for: .normal)
        }
    }
...
extension ResumeViewController: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if isEditMode, indexPath.row == skillModels.count {
            ...
            return getSkillCell(indexPath: indexPath)
        }
    }

    func deleteItem(skillModel: SkillModel) {
    ...
    private func getAddCell(indexPath: IndexPath) -> UICollectionViewCell {
    ...
    private func getSkillCell(indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(
